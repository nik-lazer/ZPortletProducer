 ...
 */
public class LiferayWSRPDhtmlLayoutPortlet extends GenericPortlet {
...
//		if (log.isDebugEnabled()) log.debug("Creates from "+path);
		...
		log.debug("Render sessionID: {}", request.getRequestedSessionId());
