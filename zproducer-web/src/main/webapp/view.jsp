<%@ page contentType = "text/html; charset=UTF-8"
         pageEncoding = "UTF-8"
         import = "javax.portlet.*, java.util.*, lan.test.portlet.simple.InitPortlet, lan.test.portlet.zk.util.UIUtils"%>
...
<%
	...
	resourceURL.setResourceID("/1.jpg");
	String imageUrl = resourceURL.toString(); %>
